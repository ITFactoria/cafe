...
/*Tabla Activos*/
INSERT INTO activos (id,idfabricante,codigo,nombre,imagenprincipal,imagendetallada,idpropietario,idtecnico,latitud,longitud,fechafingarantia,fechacreacion,fechamodificacion) VALUES (1,1,13,'activo1','imagenproncipal','imagendetallada',1,1,'latitud','longitud','2019-05-13','2019-05-13','2019-05-13');
INSERT INTO activos (id,idfabricante,codigo,nombre,imagenprincipal,imagendetallada,idpropietario,idtecnico,latitud,longitud,fechafingarantia,fechacreacion,fechamodificacion) VALUES (2,1,13,'activo1','imagenproncipal','imagendetallada',1,1,'latitud','longitud','2019-05-13','2019-05-13','2019-05-13');
INSERT INTO activos (id,idfabricante,codigo,nombre,imagenprincipal,imagendetallada,idpropietario,idtecnico,latitud,longitud,fechafingarantia,fechacreacion,fechamodificacion) VALUES (3,2,13,'activo1','imagenproncipal','imagendetallada',1,1,'latitud','longitud','2019-05-13','2019-05-13','2019-05-13');
INSERT INTO activos (id,idfabricante,codigo,nombre,imagenprincipal,imagendetallada,idpropietario,idtecnico,latitud,longitud,fechafingarantia,fechacreacion,fechamodificacion) VALUES (4,3,13,'activo1','imagenproncipal','imagendetallada',1,1,'latitud','longitud','2019-05-13','2019-05-13','2019-05-13');
